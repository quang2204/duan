	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 col-lg-3 p-b-50">
				...
				<ul>
					<li class="p-b-10">
						<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
							<i class="fa fa-phone" style="font-size: 22px;padding-right: 5px;"></i>
							0949699222
						</a>
					</li>
					...
					<li class="p-b-10">
						<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
							<i class="fa fa-envelope" style="font-size: 17px;padding-right: 5px;"></i>
					...
					<li class="p-b-10">
						<a href="#" class="stext-107 cl7 hov-cl1 trans-04">
							<i class="fa fa-map" style="font-size: 17px;padding-right: 5px;"></i>
		...
		<div class="p-t-40">
			...
			<p class="stext-107 cl6 txt-center">
				...
				Copyright 2024 © Lương Thành quang
			</p>
		</div>
	</div>
</footer>
<style>
	...
	.fb {
		...
		height: 45px;
		font-size: 25px;
		animation: 1s ease-in-out fb infinite;
		cursor: pointer;
		display: flex;
...
<script>
	...
	$('.js-addwish').each(function () {
		...
		$(this).on('click', function () {
			swal(productName, "Xóa thành công", "success");
			$(this).addClass('js-addedwish-b2');
		});
	});
