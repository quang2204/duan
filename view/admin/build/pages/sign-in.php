      ...
      <div class="container z-10">
        <div class='flex flex-wrap mt-0 -mx-3'>
          <div class="flex flex-col w-full max-w-full px-3 mx-auto md:flex-0 shrink-0 md:w-6/12 lg:w-5/12 xl:w-4/12">
            <div class="relative flex flex-col min-w-0 mt-6 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border mb-12"
                                                                                                                                    style="box-shadow: 5px 5px 10px 1px #c9c5c5;">
              ...
              <div class="flex-auto p-6">
                <form role="form">
                  ...
                  <div class="mb-4">
                    <input type="email" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                                                                                                            placeholder="Email"
                                                                                                                                            aria-label="Email"
          ...
          <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12">
            <div
              ...
              <div class="absolute inset-x-0 top-0 z-0 h-full -ml-16 bg-cover skew-x-10"
                                                                                                                                      style="background-image: url('build/assets/img/curved-images/curved6.jpg')">
              </div>
            </div>
          </div>
        </div>
