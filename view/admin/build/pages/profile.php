  ...
  <div class="w-full px-6 mx-auto">
    <div class="relative flex items-center p-0 mt-6 overflow-hidden bg-center bg-cover min-h-75 rounded-2xl"
                                                                                                                            style="background-image: url('build/assets/img/curved-view/images/curved0.jpg'); background-position-y: 50%">
      <span
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div
                  ...
                  <div class="relative">
                    <a class="block shadow-xl rounded-2xl">
                      <img src="build/assets/img/home-decor-1.jpg" alt="img-blur-shadow"
                      ...
                      <div class="mt-2">
                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30"
                          ...
                          <img class="w-full rounded-circle" alt="Image placeholder"
                                                                                                                                                  src="build/assets/img/team-1.jpg" />
                        </a>
                        ...
                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30"
                                                                                                                                                ...
                                                                                                                                                data-placement="bottom">
                          <img class="w-full rounded-circle" alt="Image placeholder"
                                                                                                                                                  src="build/assets/img/team-2.jpg" />
                        </a>
                        <div data-target="tooltip" class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                                                                                                                role="tooltip">
                          Ryan Milly
                        ...
                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30"
                                                                                                                                                ...
                                                                                                                                                data-placement="bottom">
                          <img class="w-full rounded-circle" alt="Image placeholder"
                                                                                                                                                  src="build/assets/img/team-3.jpg" />
                        </a>
                        <div data-target="tooltip" class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                                                                                                                role="tooltip">
                          Nick Daniel
                        ...
                        <a href="javascript:;" class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-xs rounded-circle hover:z-30"
                                                                                                                                                ...
                                                                                                                                                data-placement="bottom">
                          <img class="w-full rounded-circle" alt="Image placeholder"
                                                                                                                                                  src="build/assets/img/team-4.jpg" />
                        </a>
                        <div data-target="tooltip" class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                                                                                                                role="tooltip">
                          Peterson
              ...
              <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                <div
                  ...
                  <div class="relative">
                    <a class="block shadow-xl rounded-2xl">
                      <img src="build/assets/img/home-decor-2.jpg" alt="img-blur-shadow"
              ...
              <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                <div
                  ...
                  <div class="relative">
                    <a class="block shadow-xl rounded-2xl">
                      <img src="build/assets/img/home-decor-3.jpg" alt="img-blur-shadow"
                                                                                                                                              class="max-w-full shadow-soft-2xl rounded-2xl" />
                    </a>
                  </div>
                  <div class="flex-auto px-1 pt-6">
