        ...
        <div class="w-full max-w-full px-3 mb-4 xl:mb-0 xl:w-1/2 xl:flex-none">
          <div
            ...
            <div class="relative overflow-hidden rounded-2xl"
                                                                                                                                    style="background-image: url('build/assets/img/curved-view/images/curved14.jpg')">
              <span
              ...
              <div class="relative z-10 flex-auto p-4">
                ...
                <div class="flex">
                  ...
                  <div class="flex items-end justify-end w-1/5 ml-auto">
                    <img class="w-3/5 mt-2" src="build/assets/img/logos/mastercard.png" alt="logo" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="flex flex-wrap -mx-3">
                <div class="max-w-full px-3 mb-6 md:mb-0 md:w-1/2 md:flex-none">
                  <div
                    ...
                    <img class="mb-0 mr-4 w-1/10" src="build/assets/img/logos/mastercard.png" alt="logo" />
                ...
                <div class="max-w-full px-3 md:w-1/2 md:flex-none">
                  <div
                                                                                                                                          class="relative flex flex-row items-center flex-auto min-w-0 p-6 break-words bg-transparent border border-solid shadow-none rounded-xl border-slate-100 bg-clip-border">
                    <img class="mb-0 mr-4 w-1/10" src="build/assets/img/logos/visa.png" alt="logo" />
              ...
              <div class="flex items-center leading-normal text-sm">
                ...
                <button
                                                                                                                                        class="inline-block px-0 py-3 mb-0 ml-6 font-bold leading-normal text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer ease-soft-in bg-150 text-sm active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25 text-slate-700"><i
                                                                                                                                          class="mr-1 fas fa-file-pdf text-lg"></i>
                  PDF</button>
              </div>
            </li>
          ...
          <ul class="flex flex-col pl-0 mb-0 rounded-lg">
            ...
            <li class="relative flex p-6 mt-4 mb-2 border-0 rounded-xl bg-gray-50">
              <div class="flex flex-col">
                ...
                <span class="mb-2 leading-tight text-xs">Company Name: <span
                                                                                                                                          class="font-semibold text-slate-700 sm:ml-2">Stone
                    Tech Zone</span></span>
                <span class="mb-2 leading-tight text-xs">Email Address: <span
            ...
            <li class="relative flex p-6 mt-4 mb-2 border-0 rounded-b-inherit rounded-xl bg-gray-50">
              <div class="flex flex-col">
                ...
                <span class="mb-2 leading-tight text-xs">Company Name: <span
                                                                                                                                          class="font-semibold text-slate-700 sm:ml-2">Fiber
                    Notion</span></span>
                <span class="mb-2 leading-tight text-xs">Email Address: <span
