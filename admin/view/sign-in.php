      ...
      <div class="container z-10">
        <div class='flex flex-wrap mt-0 -mx-3'>
          <div class="flex flex-col w-full max-w-full px-3 mx-auto md:flex-0 shrink-0 md:w-6/12 lg:w-5/12 xl:w-4/12">
            <form method="post" class="relative flex flex-col min-w-0 mt-6 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border mb-12"
                ...
                <form method="post">
                  ...
                  <div class="mb-4 relative">
                    <input type="password" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                                                                                                            ...
                                                                                                                                            name="pass"
                                                                                                                                            id="password" />
                    <div class="mat absolute right-4" style='top: 0.5rem;'>
                  ...
                  <div class="min-h-6 mb-0.5 block pl-12 ">
                    ...
                    <div class="d-flex justify-content-between">
                      <label class="mb-2 ml-1 font-normal cursor-pointer select-none text-sm text-slate-700"
                        ...
                        me</label>
                      <a href='?act=resetpass'>Quên mật khẩu</a>
                    </div>
