            ...
            <div
                ...
                <div class="flex-auto px-0 pt-0 ">
                  ...
                  align-items: center; gap:20px;padding: 52px 0;">
                                            <a href="?act=suacolor&id=<?= $value['id'] ?>">
                                                <button class="c-button c-button--gooey"> Update

                                                </button>
                                            </a>
                                            <form action="?act=statcolor" method='post'>
...
<ul class="pagination d-flex justify-content-center">
    ...
    <?php if ($page > 1): ?>
        <li class="page-item">
            <a class="page-link" href="?act=color&trang=<?= $page - 1; ?><?= $link ?>">Prev</a>
        </li>
    <?php endif; ?>
    <?php if ($totalPages > 1):
        for ($i = 1; $i <= $totalPages; $i++): ?>
            <li class="page-item <?= ($i == $page) ? 'active' : ''; ?>">
                <a class="page-link" href="?act=color&trang=<?= $i; ?><?= $link ?>">
                    <?= $i; ?>
                </a>
            </li>
    ...
    <?php if ($page < $totalPages): ?>
        <li class="page-item">
            <a class="page-link" href="?act=color&trang=<?= $page + 1; ?><?= $link ?>">Next</a>
        </li>
    <?php endif; ?>
</ul>