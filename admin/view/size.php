            ...
            <div
                ...
                <div
                    ...
                    <a href="?act=themsize">
                        <button type="button" class="button" style="background-color: #3aa856;">
                            <span class="button__text">Add size </span>
                ...
                <div class="flex-auto px-0 pt-0 ">
                  ...
                  align-items: center; gap:20px;padding: 52px 0;">
                                            <a href="?act=suasize&id=<?= $value['id'] ?>">
                                                <button class="c-button c-button--gooey"> Update

                                                </button>
                                            </a>
                                            <form action="?act=statsize" method='post'>
...
<ul class="pagination d-flex justify-content-center">
    <?php if ($page > 1): ?>
        <li class="page-item">
            <a class="page-link" href="?act=size&trang=<?= $page - 1; ?>">Prev</a>
        </li>
    <?php endif; ?>
    <?php if ($totalPages > 1):
        for ($i = 1; $i <= $totalPages; $i++): ?>
            <li class="page-item <?= ($i == $page) ? 'active' : ''; ?>">
                <a class="page-link" href="?act=size&trang=<?= $i; ?>">
                    <?= $i; ?>
                </a>
            </li>
    ...
    <?php if ($page < $totalPages): ?>
        <li class="page-item">
            <a class="page-link" href="?act=size&trang=<?= $page + 1; ?>">Next</a>
        </li>
    <?php endif; ?>
</ul>